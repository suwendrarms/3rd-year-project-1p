                        ...
                        <form method="post" action="/" id="custom-form-wizard">
                            <div class="wizard steps-bg steps-left">
                                ...
                                <section class="wizard-section">
                                    ...
                                    <div class="section">
                                        <label for="input002"><h6 class="mb20 mt40">Employee Number</h6></label>
                                ...
                                <h4 class="wizard-section-title">
                                    <i class="fa fa-file-text pr5"></i> Other Employment Details </h4>
                                <section class="wizard-section">
                                    ...
                                    <div class="section">
                                        <label for="input002"><h6 class="mb20 mt40"> Are You Complete.</h6></label>
